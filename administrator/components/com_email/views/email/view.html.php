...
class EmailViewEmail extends JView
{
    ...
    protected function addToolBar()
    {
        ...
        $canDo = EmailHelper::getActions($this->item->id);
        $doc=JFactory::getDocument();
        $doc->addStyleSheet(JURI::root().'media/com_email/css/admin.stylesheet.css');
        JToolBarHelper::title($isNew ? JText::_('COM_EMAIL_MANAGER_EMAIL_NEW') : JText::_('COM_EMAIL_MANAGER_EMAIL_EDIT'), $isNew ? 'new.png' :'edit.png');
    ...
    protected function setDocument()
    {
        ...
        $document->setTitle($isNew ? JText::_('COM_EMAIL_EMAIL_CREATING') : JText::_('COM_EMAIL_EMAIL_EDITING'));
        $document->addScript(JURI::root() . $this->script);
        $document->addScript(JURI::root() . "/administrator/components/com_email/views/email/submitbutton.js");
        JText::script('COM_EMAIL_EMAIL_ERROR_UNACCEPTABLE');
    }
}